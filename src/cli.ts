...
for (const job of ['discover-teams', 'detect-sites', 'sweep-scoreboard', 'fetch-games-ncaa', 'sync-site', 'reconcile-games', 'compute-aggregates', 'refresh-rankings', 'verify-membership', 'compute-standings', 'resolve-orphans', 'live', 'pq-health', 'backfill', 'sync-program', 'hourly', 'standings', 'nightly', 'weekly', 'quality', 'ops-retention', 'weather']) {
