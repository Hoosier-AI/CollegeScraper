  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <label className="flex items-center gap-1 text-sm text-ink-400"><input type="checkbox" checked={!members} onChange={(e) => setMembers(!e.target.checked)} /> show non-NCAA opponents</label>
      </div>
